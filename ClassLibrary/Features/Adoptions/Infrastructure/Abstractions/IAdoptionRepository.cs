...
namespace ClassLibrary.Features.Adoptions.Infrastructure.Abstractions
{
    /// <summary>
    ...
    public interface IAdoptionRepository : IRepository<Adoption>
    {
        ...
        /// </summary>
        Task<IEnumerable<Adoption>> GetBySpeciesAsync(AnimalManagement.Core.Enums.Species species); // Opdateret med fuldt namespace for klarhed
